...
/** Circled "i" — opens the Request section's contextual help tooltip. */
...
/** A single die showing 3 pips — "Fill with random data". */
...
/** Wand + sparkles — reformat this JSON (Raw editor's Beautify control). */
